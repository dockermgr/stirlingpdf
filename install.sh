...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
##@Version           :  202410081643-git
# @@Author           :  Jason Hempstead
# @@Contact          :  jason@casjaysdev.pro
# @@License          :  LICENSE.md
# @@ReadME           :  install.sh --help
# @@Copyright        :  Copyright: (c) 2024 Jason Hempstead, Casjays Developments
# @@Created          :  Tuesday, Oct 08, 2024 16:43 EDT
# @@File             :  install.sh
# @@Description      :  Container installer script for stirlingpdf
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
export APPNAME="stirlingpdf"
export VERSION="202410081643-git"
...
DOCKER_REGISTRY_REPO_NAME="stirlingpdf"
...
CONTAINER_ENV_USER_NAME="SECURITY_INITIALLOGIN_USERNAME"
CONTAINER_ENV_PASS_NAME="SECURITY_INITIALLOGIN_PASSWORD"
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
CONTAINER_MOUNTS="HOST/data/ocr:/usr/share/tessdata"
CONTAINER_MOUNTS+=""
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
...
# - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -
# Set custom script - saves to /config/env/stirlingpdf.script.sh
...
if [ -n "$STIRLINGPDF_USERNAME" ]; then
  CONTAINER_USER_NAME="$STIRLINGPDF_USERNAME"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
  CONTAINER_USER_NAME="${STIRLINGPDF_USERNAME:-${CONTAINER_USER_NAME:-$DEFAULT_USERNAME}}"
fi
if [ -n "$CONTAINER_USER_NAME" ]; then
...
if [ -n "$STIRLINGPDF_PASSWORD" ]; then
  CONTAINER_USER_PASS="$STIRLINGPDF_PASSWORD"
fi
if [ -n "$CONTAINER_USER_PASS" ]; then
  ...
  CONTAINER_USER_PASS="${STIRLINGPDF_PASSWORD:-${CONTAINER_USER_PASS:-$DEFAULT_PASSWORD}}"
fi
if [ -n "$CONTAINER_USER_PASS" ]; then
